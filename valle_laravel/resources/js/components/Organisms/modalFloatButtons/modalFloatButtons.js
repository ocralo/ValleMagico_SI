...
const ModalFloatButtons = ({
    ...
    const [
        isRoleAndPermissionSelected,
        setIsRoleAndPermissionSelected
    ] = useState(false);
            ...
            setValidationSchema(
                Yup.object().shape({
                    ...
                    password: Yup.string()
                        .min(
                            8,
                            "La contraseña debe deten por lo menos 8 caracteres"
                        )
                                ...
                                <Formik
                                    ...
                                    onSubmit={fields => {
                                        ...
                                        if (slug_Permission == "hq_grades") {
                                            ...
                                            checkedBox.map(item => {
                                                ...
                                                auxLocationUserGrade.push(
                                                    idGrade[0],
                                                    idGrade[1]
                                                );
                                            });
                                            setuserHerarquyGrades(
                                                auxLocationUserGrade
                                            );
                                    ...
                                    render={({ errors, status, touched }) => {
                                        ...
                                        function getIdChecked(
                                            ...
                                            console.log(
                                                "TCL: getIdChecked -> idsCheckedButtons",
                                                idsCheckedButtons
                                            );
                                            if (existValue) {
                                                ...
                                                let index = auxCheckedBox.indexOf(
                                                    idsCheckedButtons
                                                );
                                                let spliceCheckbox = auxCheckedBox.splice(
                                                    index,
                                                    1
                                                );
