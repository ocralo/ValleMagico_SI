...
const ContentSelectedListUsers = ({ roles, permissions, infoLocation }) => {
    ...
    const urlFetchUpdate = `${process.env.OPEN_VALLE_MAGICO_URL}updateUser/${
        params.idForFetch
    }`;
    ...
    async function fetchData() {
        try {
            const result = await fetchApi(
                `${process.env.OPEN_VALLE_MAGICO_URL}getUser/${
                    params.idForFetch
                }`
            );
    ...
    function getIdPermission(result) {
        permissions.map(item => {
            let permission = result.permissions.find(
                    ...
                    <div className="d-flex justify-content-between mt-1 mb-1">
                        ...
                        {isDisabled == true && (
                            <div className="d-flex">
                                <EditButton
                                    iconButton={"edit"}
                                    EventHandleClick={handleClickEdit}
                                />
                                {/* <EditButton idModal={"ModalDelete"} iconButton={'trash'} /> */}
                                <button
                                    type="button"
                                    className="btn btn-edit d-flex justify-content-center align-items-center"
                                    data-toggle="modal"
                        ...
                        <ModalDelete
                            ...
                            textBody={"Seguro quiere eliminar este usuario"}
                            urlFetch={`${
